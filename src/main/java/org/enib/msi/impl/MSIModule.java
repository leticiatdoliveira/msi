 ...
 * 
 */
public class MSIModule extends AbstractJavaModule {

	private MSIPeerModule peerModule = null;

	private MSILifeCycleHandler lifeCycleHandler = null;
	
	private static MSIModule instance;

	public static MSIModule getInstance() {
		return instance;
	}

	@Override
	public MSIPeerModule getPeerModule() {
	 ...
	 */
	public MSIModule(IModuleContext moduleContext) {
		super(moduleContext);

		MSIModule.instance = this;

		this.lifeCycleHandler = new MSILifeCycleHandler(this);
		this.peerModule = new MSIPeerModule(this, moduleContext.getPeerConfiguration());
